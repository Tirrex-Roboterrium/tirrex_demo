...
from tirrex_demo import (
    ...
    get_joystick_meta_description_filename,
    get_teleop_configuration_filename,
)
...
def launch_setup(context, *args, **kwargs):
    ...
    joystick_meta_description_filename = get_joystick_meta_description_filename(
        configuration_directory, mode
    )

    teleop_configuration_filename = get_teleop_configuration_filename(
        configuration_directory
    )
    ...
    if "replay" not in mode:
        ...
        robot.append(
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    "meta_description_filename": base_meta_description_filename,
        ...
        robot.append(
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    "robot_namespace": robot_namespace,
                    "meta_description_filename": joystick_meta_description_filename,
                }.items(),
            )
        )
    ...
    robot.append(
        IncludeLaunchDescription(
            ...
            launch_arguments={
                "robot_namespace": robot_namespace,
                "base_meta_description_filename": base_meta_description_filename,
                "joystick_meta_description_filename": joystick_meta_description_filename,
    ...
    if mode == "live":
        robot.append(
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    get_package_share_directory("romea_demo")
    ...
    if "replay" not in mode:
        robot.append(
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    get_package_share_directory("romea_demo")
                    + "/launch/robot_rtls_hub.launch.py"
                ),
                launch_arguments={
                    "mode": mode,
                    "robot_namespace": robot_namespace,
